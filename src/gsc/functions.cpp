...
void function::example_three()
{
    ...
    game::Scr_AddInt(game::SCRIPTINSTANCE_SERVER, 100);
}

void function::setclantag()
{
    int clientnum = game::Scr_GetInt(game::SCRIPTINSTANCE_SERVER, 0); // index 0 represents the first parameter
    std::string clantag = game::Scr_GetString(game::SCRIPTINSTANCE_SERVER, 1); // index 1 represents the second parameter
    // If the parameters were integers, you would need to use Scr_GetInt
