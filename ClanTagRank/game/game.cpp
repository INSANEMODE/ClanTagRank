...
namespace game
{
	...
	Info_ValueForKey_t Info_ValueForKey = Info_ValueForKey_t(select_value(0x68B420, 0x0046AD00, 0x5C2DB0));

	I_CleanStr_t I_CleanStr = I_CleanStr_t(select_value(0x44F2B0, 0x00483F40, 0x5C2C60));
